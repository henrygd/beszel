...
type Info struct {
  ...
  Disks         []DiskInfo    `json:"d,omitempty cbor:"14,keyasint,omitempty"`
	Networks      []NetworkInfo `json:"n,omitempty cbor:"15,keyasint,omitempty"`
	Memory        []MemoryInfo  `json:"m,omitempty cbor:"16,keyasint,omitempty"`
	Cpus          []CpuInfo     `json:"c,omitempty cbor:"17,keyasint,omitempty"`
	Oses          []OsInfo      `json:"o,omitempty cbor:"18,keyasint,omitempty"`
}
