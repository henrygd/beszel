...
func (rm *RecordManager) AverageSystemStats(records Stats) system.Stats {
	sum := system.Stats{
...
func (rm *RecordManager) AverageContainerStats(records Stats) []container.Stats {
	...
	for _, record := range records {
		...
		// Unmarshal into the existing slice
