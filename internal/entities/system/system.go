...
type Stats struct {
	...
	CpuUser        float64             `json:"cpuu" cbor:"42,keyasint"`
	CpuSystem      float64             `json:"cpus" cbor:"43,keyasint"`
	CpuIowait      float64             `json:"cpui" cbor:"44,keyasint"`
	CpuSteal       float64             `json:"cpusl" cbor:"45,keyasint"`
	CpuCores       map[string]CpuCoreStats `json:"cpuc,omitempty" cbor:"46,keyasint,omitempty"`
	...
	SwapTotal      float64             `json:"st,omitempty" cbor:"47,keyasint,omitempty"`
	SwapCached     float64             `json:"sc,omitempty" cbor:"48,keyasint,omitempty"`
...
type FsStats struct {
	...
	InodeUsed         uint64 `json:"iu,omitempty" cbor:"8,keyasint,omitempty"`
	InodeTotal        uint64 `json:"it,omitempty" cbor:"9,keyasint,omitempty"`
	InodePct          float64 `json:"ip,omitempty" cbor:"10,keyasint,omitempty"`
}
...
type Info struct {
	...
	ExtraFs        map[string]*InfoFsStats `json:"efs,omitempty" cbor:"21,keyasint,omitempty"`
}
