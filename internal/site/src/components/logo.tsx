...
/** "B" monogram — the wordmark's first glyph, cropped from the same path. */
export function LogoMark({ className }: { className?: string }) {
	const id = useId()

	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 57 74" className={className} aria-hidden="true">
			<defs>
				<linearGradient id={id} x1="0%" y1="20%" x2="100%" y2="120%">
					<stop offset="10%" style={{ stopColor: "#747bff" }} />
					<stop offset="90%" style={{ stopColor: "#24eb5c" }} />
