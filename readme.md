...
[![agent Docker Image Size](https://img.shields.io/docker/image-size/nguyendkn/cmonitor-agent/0.4.0?logo=docker&label=agent%20image%20size)](https://hub.docker.com/r/nguyendkn/cmonitor-agent)
[![hub Docker Image Size](https://img.shields.io/docker/image-size/nguyendkn/beszel/0.4.0?logo=docker&label=hub%20image%20size)](https://hub.docker.com/r/nguyendkn/beszel)
[![MIT license](https://img.shields.io/github/license/nguyendkn/beszel?color=%239944ee)](https://github.com/nguyendkn/beszel-hub/blob/main/LICENSE)
[![Crowdin](https://badges.crowdin.net/beszel/localized.svg)](https://crowdin.com/project/beszel)

![Screenshot of beszel dashboard and system page](https://nguyendkn-assets.b-cdn.net/beszel/screenshot-new.png)
